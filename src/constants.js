...
export const NAV_ITEMS = [
  ...
  { href: "/student/placement", label: "My Placement Score", icon: BarChart3, roles: ["student", "individual_student"], modules: ["both", "ai_interview"] },
  ...
  { href: "/referral", label: "Refer & Earn", icon: Gift, roles: ["individual_student"] },
  ...
  { href: "/admin/placement", label: "Placement Intelligence", icon: BarChart3, roles: ["admin", "master_admin"], modules: ["both", "ai_interview"] },
  ...
  { href: "/master-admin/revenue", label: "Revenue Reports", icon: IndianRupee, roles: ["master_admin"] },
  ...
  { href: "/master-admin/referrals", label: "Referral Management", icon: Gift, roles: ["master_admin"] },
